        ...
        for use_svd in [False, True]:
            ...
            for model_name, model in models_config.items():
                ...
                if model_name == "Naive Bayes" and vector_type != 'Embeddings' and not use_svd:
                    reporte = train_and_evaluate_model(X_train_vect, y_train, X_test_vect, y_test, model, model_name)
                    reporte = f"Representación: {vector_type} - SVD: {use_svd} - {model_name}\n{reporte}"
